...
let voiceAgents: VoiceAgent[] = [
  ...
  },
  {
    id: "narendra_modi",
    name: "Narendra Modi",
    description: "💎 PREMIUM: Iconic Indian orator voice — Hindi/English addresses. Powered by Fish Audio.",
    creator: "Celebrity",
    prompt: "You are Narendra Modi. Speak with his distinctive oratorical style and cadence.",
    price: 1.0,
    category: "Entertainment",
    voiceStyle: "Iconic",
    createdAt: new Date().toISOString(),
    sales: 0,
    rating: 5.0,
    celebrityName: "Narendra Modi",
    voiceId: "narendra-modi",
    image: "https://via.placeholder.com/400?text=Narendra+Modi",
  },
  {
    id: "donald_trump",
    name: "Donald Trump",
